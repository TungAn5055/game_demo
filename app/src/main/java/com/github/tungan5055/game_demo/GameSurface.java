...
import static com.github.tungan5055.game_demo.R.raw.explosion;
  ...
  // Đảm bảo Game Surface có thể focus để điều khiển các sự kiện.
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        while(iterator.hasNext()){
            ...
            if(explosion.isFinish()) {// Nếu explosion đã hoàn thành, loại nó ra khỏi iterator & list.
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Bitmap chibiBitmap1 = BitmapFactory.decodeResource(this.getResources(),R.drawable.a);
        ChibiCharacter chibi1 = new ChibiCharacter(this,chibiBitmap1,100,50);

        Bitmap chibiBitmap2 = BitmapFactory.decodeResource(this.getResources(),R.drawable.b);
